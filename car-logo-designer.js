...
// Shield Logo Style (Ferrari-inspired)
function generateShieldLogo(name, initials, colors) {
    return `
        <svg viewBox="0 0 300 350" xmlns="http://www.w3.org/2000/svg" width="300" height="350">
            ...
            <text x="150" y="200"
                  font-family="Arial, sans-serif"
                  font-size="${name.length > 10 ? 24 : 32}"
                  font-weight="900"
                  fill="${colors.text}"
                  text-anchor="middle">
                ${name}
            ...
            <!-- Bottom Accent -->
            <path d="M 80 260 Q 150 280 220 260"
                  stroke="${colors.accent}"
                  stroke-width="3"
                  fill="none"/>
        </svg>
...
function generateBadgeLogo(name, initials, colors) {
    return `
        <svg viewBox="0 0 320 380" xmlns="http://www.w3.org/2000/svg" width="320" height="380">
            ...
            <text x="160" y="210"
                  font-family="Arial, sans-serif"
                  font-size="${name.length > 12 ? 22 : 28}"
                  font-weight="900"
                  fill="${colors.text}"
                  text-anchor="middle">
                ${name}
            ...
            <!-- Bottom Decoration -->
            <path d="M 100 270 L 160 290 L 220 270"
                  stroke="${colors.accent}"
                  stroke-width="3"
                  fill="none"/>
            <circle cx="160" cy="270" r="8" fill="${colors.accent}"/>
        </svg>
    `;
}
