...
// Themes data with backgrounds
const themes = [
    {
        id: 'default',
        name: 'Crimson Bolt',
        colors: { primary: '#dc143c', secondary: '#1e90ff' },
        background: `linear-gradient(135deg, rgba(0, 0, 0, 0.8) 0%, rgba(20, 0, 10, 0.9) 25%, rgba(10, 0, 30, 0.85) 50%, rgba(20, 0, 10, 0.9) 75%, rgba(0, 0, 0, 0.8) 100%), radial-gradient(ellipse at 10% 20%, rgba(220, 20, 60, 0.4) 0%, transparent 50%), radial-gradient(ellipse at 90% 80%, rgba(30, 144, 255, 0.3) 0%, transparent 50%), radial-gradient(ellipse at 50% 50%, rgba(138, 43, 226, 0.25) 0%, transparent 70%), linear-gradient(180deg, #000000 0%, #0a0a0a 100%)`,
        cost: 0,
        icon: '⚡'
    },
    {
        ...
        background: `radial-gradient(ellipse at 30% 40%, rgba(0, 206, 209, 0.4) 0%, transparent 50%), radial-gradient(ellipse at 70% 60%, rgba(30, 144, 255, 0.35) 0%, transparent 50%), radial-gradient(ellipse at 50% 80%, rgba(64, 224, 208, 0.25) 0%, transparent 60%), linear-gradient(180deg, #001a33 0%, #000a1a 100%)`,
        cost: 50,
        icon: '🌊'
    },
    {
        ...
        background: `linear-gradient(180deg, rgba(255, 99, 71, 0.5) 0%, rgba(255, 140, 0, 0.4) 40%, rgba(255, 215, 0, 0.3) 70%, rgba(0, 0, 0, 0.9) 100%), radial-gradient(ellipse at 50% 30%, rgba(255, 140, 0, 0.3) 0%, transparent 50%), linear-gradient(180deg, #1a0a00 0%, #000000 100%)`,
        cost: 75,
        icon: '🌅'
    },
    {
        ...
        background: `radial-gradient(circle at 20% 50%, rgba(255, 255, 255, 0.1) 0%, transparent 1%), radial-gradient(circle at 80% 80%, rgba(255, 255, 255, 0.15) 0%, transparent 1%), radial-gradient(circle at 40% 20%, rgba(255, 255, 255, 0.08) 0%, transparent 1%), radial-gradient(circle at 90% 40%, rgba(255, 255, 255, 0.12) 0%, transparent 1%), radial-gradient(circle at 30% 80%, rgba(255, 255, 255, 0.1) 0%, transparent 1%), radial-gradient(circle at 60% 60%, rgba(255, 255, 255, 0.09) 0%, transparent 1%), radial-gradient(ellipse at 50% 50%, rgba(135, 206, 235, 0.2) 0%, transparent 60%), linear-gradient(180deg, #000428 0%, #004e92 100%)`,
        cost: 100,
        icon: '⭐'
    },
    {
        ...
        background: `radial-gradient(ellipse at 40% 30%, rgba(34, 139, 34, 0.4) 0%, transparent 50%), radial-gradient(ellipse at 60% 70%, rgba(144, 238, 144, 0.3) 0%, transparent 50%), radial-gradient(ellipse at 20% 80%, rgba(46, 139, 87, 0.3) 0%, transparent 40%), linear-gradient(180deg, #001a00 0%, #000a00 100%)`,
        cost: 125,
        icon: '🌲'
    },
    {
        ...
        background: `linear-gradient(135deg, rgba(26, 42, 108, 0.4) 0%, rgba(178, 31, 31, 0.4) 33%, rgba(253, 187, 45, 0.4) 66%, rgba(26, 42, 108, 0.4) 100%), radial-gradient(ellipse at 50% 30%, rgba(0, 255, 157, 0.2) 0%, transparent 50%), radial-gradient(ellipse at 80% 70%, rgba(147, 112, 219, 0.3) 0%, transparent 50%), radial-gradient(ellipse at 20% 60%, rgba(218, 112, 214, 0.25) 0%, transparent 40%), linear-gradient(180deg, #0a0a1a 0%, #1a0a2e 100%)`,
        cost: 150,
        icon: '🌌'
    },
    {
        id: 'matrix',
        name: 'Digital Matrix',
        colors: { primary: '#00ff00', secondary: '#39ff14' },
        background: `repeating-linear-gradient(0deg, rgba(0, 26, 0, 0.5) 0px, rgba(0, 0, 0, 0.8) 2px, rgba(0, 0, 0, 0.9) 4px), linear-gradient(90deg, rgba(0, 255, 0, 0.03) 0%, transparent 100%), radial-gradient(ellipse at 50% 50%, rgba(0, 255, 0, 0.15) 0%, transparent 70%), linear-gradient(180deg, #000000 0%, #001a00 100%)`,
        cost: 175,
        icon: '💻'
    },
    {
        ...
        background: `repeating-linear-gradient(90deg, transparent 0px, transparent 48px, rgba(255, 0, 255, 0.1) 48px, rgba(255, 0, 255, 0.1) 50px), repeating-linear-gradient(0deg, transparent 0px, transparent 48px, rgba(0, 255, 255, 0.1) 48px, rgba(0, 255, 255, 0.1) 50px), radial-gradient(ellipse at 30% 40%, rgba(255, 0, 255, 0.2) 0%, transparent 50%), radial-gradient(ellipse at 70% 60%, rgba(0, 255, 255, 0.2) 0%, transparent 50%), linear-gradient(135deg, #0a0015 0%, #15001a 100%)`,
        cost: 200,
        icon: '🎮'
    },
    {
        id: 'galaxy',
        name: 'Deep Galaxy',
        colors: { primary: '#9370DB', secondary: '#FF1493' },
        background: `radial-gradient(ellipse at 20% 30%, rgba(147, 51, 234, 0.3) 0%, transparent 50%), radial-gradient(ellipse at 80% 70%, rgba(59, 130, 246, 0.25) 0%, transparent 50%), radial-gradient(ellipse at 50% 50%, rgba(236, 72, 153, 0.2) 0%, transparent 60%), radial-gradient(circle at 10% 80%, rgba(255, 255, 255, 0.05) 0%, transparent 2%), radial-gradient(circle at 90% 20%, rgba(255, 255, 255, 0.08) 0%, transparent 2%), radial-gradient(circle at 30% 40%, rgba(255, 255, 255, 0.06) 0%, transparent 2%), radial-gradient(circle at 70% 85%, rgba(255, 255, 255, 0.07) 0%, transparent 2%), linear-gradient(180deg, #0d0221 0%, #240b36 100%)`,
        cost: 250,
        icon: '🌠'
    }
];
